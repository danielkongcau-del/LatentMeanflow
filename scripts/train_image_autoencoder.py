...
DEFAULT_CONFIG = REPO_ROOT / "configs" / "autoencoder_image_256.yaml"


def parse_args():
    parser = argparse.ArgumentParser(description="Train the project-layer image-only autoencoder/tokenizer.")
