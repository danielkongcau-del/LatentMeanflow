...
class DeepLab(nn.Module):
    def __init__(self, num_classes, backbone="mobilenet", pretrained=True, downsample_factor=16,drop_path_rate=0.1):
...
if __name__ == "__main__":
    ...
    net = DeepLab(num_classes=2, backbone='resnet', drop_path_rate=0.1, ).cuda()
