...
from Nets.soft_moe.soft_moe_with_dynamic_slots import DynamicSlotsSoftMoE
...
def config_swinsmt(img_size=512, n_classes=4):
    model = SwinSMT(
        in_channels=3,
...
if __name__ == "__main__":
    ...
    net = config_swinsmt(img_size=512, n_classes=4).cuda()
    print(net)
