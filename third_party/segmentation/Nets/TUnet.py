...
class ScoreNet(nn.Module):
    def __init__(self, n_classes, num_heads: int = 32, drop_path_rate=0.1):
        ...
        self.up1 = ScoreUp(512, 256, num_heads, dpr[0])  # in_channels, out_channels, num_heads: int = 32, drop_path_rate=0.
        self.up2 = ScoreUp(256, 128, num_heads, dpr[1])
        self.up3 = ScoreUp(128, 64, num_heads, dpr[2])
        self.up4 = ScoreUp(64, 64, num_heads, dpr[3])
...
if __name__ == '__main__':
    ...
    net = ScoreNet(n_classes=4, num_heads=1, drop_path_rate=0.3).cuda()
