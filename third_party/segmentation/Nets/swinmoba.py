...
class BasicLayer(nn.Module):
    ...
    def __init__(self, use_shifted_window, use_relat_position, use_moe, topk, dim, input_resolution, depth, num_heads, window_size,
...
class SwinMoBA(nn.Module):
    ...
    def __init__(self, use_shifted_window=True, use_relat_position=True, use_moe=True, topk=3, 
