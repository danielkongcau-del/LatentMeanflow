...
class Up(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, bilinear=True, drop_path_rate=0.1,expert_num=2,learnable_vec=0.5,use_moe=True):
        super().__init__()
        ...
        self.conv = SimplyDifferenceMoE(
            expert=SimplyExpert(in_channels=in_channels, out_channels=out_channels, drop_path_rate=drop_path_rate,
                                use_moe=True),
            in_dim=in_channels,
            ...
            proj_use_norm=True
        ) if use_moe else SimplyExpert(in_channels=in_channels, out_channels=out_channels,
...
class DownPPM(nn.Module):
    ...
    def forward(self, x):
        return self.maxpool_conv(x)
class CPUNet_moe(nn.Module):
    def __init__(self, n_classes, bilinear=True, drop_path_rate=0.1,use_moe=True,expert_num=2,learnable_vec=0.5):
        super(CPUNet_moe, self).__init__()
        ...
        self.up1 = Up(1024, 256, bilinear, drop_path_rate,use_moe=use_moe, expert_num=expert_num, learnable_vec=learnable_vec)
        self.up2 = Up(512, 128, bilinear, drop_path_rate,use_moe=use_moe, expert_num=expert_num, learnable_vec=learnable_vec)
        self.up3 = Up(256, 64, bilinear, drop_path_rate,use_moe=use_moe, expert_num=expert_num, learnable_vec=learnable_vec)
        self.up4 = Up(128, 64, bilinear, drop_path_rate,use_moe=use_moe, expert_num=expert_num, learnable_vec=learnable_vec)
