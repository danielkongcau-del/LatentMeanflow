...
def do_search(args, task=0):
    args.pt_root = r'E:\12_guorun\1-cv-classify\guoruns-segmentation-hub\work_dir\seg\Dy_Global\Disease\Dy_Seg_Nq5\aug-Dy_Seg_Global-h512w512-erode0-weighting_none'
    pt_dirs = []
