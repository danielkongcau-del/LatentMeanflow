...
def do_test(mode, args):
    ...
    msg=net.load_state_dict(torch.load(pt_path), strict=False)
    ...
    if mode == 0:
        eval_dataset_full(net, args.out_channels, test_loader, class_weights=class_weights, save_dir=pt_dir, is_val=False)
...
def do_search(args, task=0):
    args.pt_root = r'E:\12_guorun\1-cv-classify\guoruns-segmentation-hub\work_dir\seg\Dy_Global\Disease\Dy_Seg_Nq5\aug-Dy_Seg_Global-h512w512-erode0-weighting_none\Dy_Seg_Global_best.pt'
    pt_dirs = []

    if task == 0:
        args.test_videos = 'none'
        args.test_set = r'E:\12_guorun\dataset\normal_datasets\seg\aug-disease\test'
        args.save_dir = r'E:\12_guorun\1-cv-classify\guoruns-segmentation-hub\work_dir\seg\Dy_Global\Disease\Dy_Seg_Nq5\aug-Dy_Seg_Global-h512w512-erode0-weighting_none\vis_test'
        args.test_images = r'E:\12_guorun\dataset\normal_datasets\seg\aug-pest\test\images'
