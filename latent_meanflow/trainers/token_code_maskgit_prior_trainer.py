...
class TokenCodeMaskGitPriorTrainer(pl.LightningModule):
    ...
    def _build_masked_modeling_inputs(self, code_sequence):
        ...
        mask = self.backbone.get_random_mask(batch_size, sequence_length)
        ...
        return masked_input_tokens, target_tokens, loss_targets, mask
    ...
    def forward(self, batch, objective_step=None):
        ...
        masked_input_tokens, target_tokens, loss_targets, mask = self._build_masked_modeling_inputs(code_sequence)
